...
int process_psr(char* name,int udpsock,struct sockaddr_in targetsin,int id,char** mr_array){
...
int process_ss_request(char* name,int hp, int exp, char x, char y, int udpsock, struct sockaddr_in targetsin, int id,char** mr_array){
